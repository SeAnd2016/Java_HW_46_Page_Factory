...
public class SignupPF {
	...
	public static void validate(WebDriver driver, String url) {
		...
		CommonPF.pageValidationPF("14. Element [Gender (label)]: ", 		CommonPF.pf_el_14);
		...
		CommonPF.pageValidationPF("42. Element [Gender (field)): ", 	CommonPF.pf_el_42);
		CommonPF.pageValidationPF("43. Element [Back (button)]: ", 	CommonPF.pf_el_43);
